...
public class ExpenditureEnquiry extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.expenditure_enquiry);
		box1 = (CheckBox) findViewById(R.id.box1);
		box2 = (CheckBox) findViewById(R.id.box2);
		box3 = (CheckBox) findViewById(R.id.box3);
		myDb = new DB(ExpenditureEnquiry.this, "category");
	    ...
	    datapicker.init(year1, month1, day1, new OnDateChangedListener() {
	        ...
	        public void onDateChanged(DatePicker view, int year, int monthOfYear,
	            int dayOfMonth) {
				ExpenditureEnquiry.this.year1 = year;
				ExpenditureEnquiry.this.month1 = monthOfYear;
				ExpenditureEnquiry.this.day1 = dayOfMonth;
	        }
	      });
	    ...
	    datapicker.init(year2, month2, day2, new OnDateChangedListener() {
	        ...
	        public void onDateChanged(DatePicker view, int year, int monthOfYear,
	            int dayOfMonth) {
	        	ExpenditureEnquiry.this.year2 = year;
	        	ExpenditureEnquiry.this.month2 = monthOfYear;
	        	ExpenditureEnquiry.this.day2 = dayOfMonth;
	        }
	      });
	...
	public void onClick1(View v) {
		...
		if(box2.isChecked()) {
				...
				int dateend = year1*365+month1*30+day1*1;
		...
		if(box3.isChecked()) {
			...
			if((ms.trim().equals("")||me.trim().equals(""))) {
				Toast.makeText(ExpenditureEnquiry.this, "金额条件不能为空", Toast.LENGTH_LONG).show();
				return;
			}else {
				if(Pattern.matches("\\D",ms)||Pattern.matches("\\D",me))
				{
					Toast.makeText(ExpenditureEnquiry.this, "非法字符,需要重新输入", Toast.LENGTH_LONG).show();
		...
		intent.setClass(ExpenditureEnquiry.this, ExpenditureResult.class);
		startActivity(intent);
	}
	public void onClick2(View v) {
		Intent intent=new Intent(ExpenditureEnquiry.this, MainActivity.class);
		startActivity(intent);
		finish();
	}
	public void categoryclick(View view) {
		Builder builder = new AlertDialog.Builder(ExpenditureEnquiry.this);
